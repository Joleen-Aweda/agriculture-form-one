# Agriculture for Secondary Schools Student’s Book Form One — ADT Bundle Reference
...
**Agriculture for Secondary Schools Student’s Book Form One** — This is an English-language Agriculture textbook for Form One secondary school learners in Tanzania, published by the Tanzania Institute of Education, so it is aimed at lower secondary level students, roughly early teenagers. The book introduces core agricultural knowledge and practical skills in crop and livestock production, covering soil science, horticulture, vegetable production, specific crops such as amaranth, Chinese cabbage, onion and tomato, and poultry enterprises including layers, broilers, indigenous chickens, hybrids and ducks. Its overall approach is strongly competency-based and practical, using activities, projects, exercises and record-keeping to link classroom learning with school, home and community farming, while emphasising entrepreneurship, good agricultural practices, productivity and sustainability.
...
├── AGRICULTURE-FORM-ONE-.db                    # SQLite database (pipeline state)
├── AGRICULTURE-FORM-ONE-.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania, Ministry of Education, Science and Technology, No. 1228, approving Agriculture for Secondary Schools Student’s Book Form One for use in Tanzania secondary schools under the 2023 syllabus, signed by Dr Lyabwene M. Mtahabwa, Commissioner for Education.",
  "gl001": "abdomen",
  "gl001_def": "the lower part of the body that contains organs such as the stomach and intestines"
}
```
...
```json
{
  "abdomen": {
    "word": "abdomen",
    "definition": "the lower part of the body that contains organs such as the stomach and intestines",
    "variations": ["abdomen","abdomens"],
    "emoji": "🩺🐔"
  }
}
```
...
```json
{
  "title": "Agriculture for Secondary Schools Student’s Book Form One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-KE"
...
| Original PDF | `AGRICULTURE-FORM-ONE-.pdf` |
| Pipeline database | `AGRICULTURE-FORM-ONE-.db` (SQLite) |
